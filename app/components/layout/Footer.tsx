  ...
  return (
    <footer className={grid({
      ...
      <section>
        ...
        <Flex justify="center">
          <IconLink href="https://github.com/KCCTdensan" icon={<SiGithub />} label="GitHub: KCCTdensan" />
          <IconLink href="https://twitter.com/intent/user?user_id=444436310" icon={<SiTwitter />} label="Twitter: kcct_densan" />
        </Flex>
