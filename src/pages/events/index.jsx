...
import * as style from "../../styles/events/index.module.scss"

const EventsHome = () => {
  return (
    <Layout>
      <Seo title="大会・コンテスト出場" />

      <h1>大会・コンテスト出場</h1>

      <h2>主な実績</h2>
      <details className={style.per_year_events}>
        <summary><h3>2020年</h3></summary>
        <ul>
          <li>日本ゲーム大賞2020 U18部門 参加</li>
        </ul>
      </details>
      <details className={style.per_year_events}>
        <summary><h3>2019年</h3></summary>
        <ul>
          <li>第30回全国高等専門学校プログラミングコンテスト 競技部門 出場</li>
        </ul>
      </details>
      <details className={style.per_year_events}>
        <summary><h3>2018年</h3></summary>
        <ul>
          <li>第29回全国高等専門学校プログラミングコンテスト 競技部門 出場</li>
        </ul>
      </details>
      <details className={style.per_year_events}>
        <summary><h3>2017年</h3></summary>
        <ul>
          <li>第28回全国高等専門学校プログラミングコンテスト 競技部門 出場</li>
        </ul>
      </details>
      <details className={style.per_year_events}>
        <summary><h3>2016年</h3></summary>
        <ul>
          <li>第27回全国高等専門学校プログラミングコンテスト 競技部門 準決勝出場</li>
        </ul>
      </details>
      <details className={style.per_year_events}>
        <summary><h3>2014年</h3></summary>
        <ul>
